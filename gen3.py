...
# === Gemini Setup ===
    ...
    genai.configure('AIzaSyCq7zNTN3pebYJB2f-BT2t031pvwc85t8c')
    gemini_model = genai.GenerativeModel("models/gemini-2.5-pro-latest")
    goal = request.form.get("goal")
    if not goal:
...
if __name__ == "__main__":
    print("🚀 Running Flask app at http://127.0.0.1:4400")
