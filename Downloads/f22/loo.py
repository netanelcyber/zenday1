...
async def login_to_kroger(page, credentials):
    ...
    try:
        ...
        try:
            ...
            await page.goto("https://www.kroger.com/signin", timeout=60000, wait_until="domcontentloaded")
            ...
            try:
                ...
                await page.goto("http://www.kroger.com", timeout=630000, wait_until="domcontentloaded")
                # Navigate to signin from homepage
                try:
                    await page.click("a[href*='signin']", timeout=130000, wait_until="domcontentloaded")
                except:
                    logger.warning("Could not find signin link, trying direct URL again")
                    await page.goto("https://www.kroger.com/signin", timeout=360000, wait_until="domcontentloaded")
...
async def kroger_automation_task(request: KrogerRequest):
    ...
    try:
        ...
        async with async_playwright() as p:
            ...
            try:
                await page.wait_for_selector("div.ProductCard", timeout=250000, wait_until="domcontentloaded")
