    ...
    for category in categories:
        ...
        for page in range(1, pages + 1):
            ...
            try:
                ...
                print(f"Searching: category {category}, page {page}")
                ...
                for link in links[:max_products_per_cat]:
                    ...
                    if name and nutri:
                        ...
                        if grade >= 0.6:
                            ...
                            # Crawl recursively through other internal product links
                            ...
                            if max_depth >= 2:
                                ...
                                for rel in related_links:
                                    ...
                                    try:
                                        ...
                                        if subhref in visited:

                                            continue

                                        visited.add(subhref)

                                        sub_url = f"https://world.openfoodfacts.org{subhref}"
                                        ...
                                        print(f"Error scraping related product: {e}")
...
if __name__ == "__main__":
    ...
    dataloader = DataLoader(dataset, batch_size=16 if len(dataset) >= 16 else len(dataset), shuffle=True)
